//
//  ProductStaticCollectionViewCell.m
//  iMojiMaker
//
...
@interface ProductStaticCollectionViewCell ()
...
@implementation ProductStaticCollectionViewCell
...
- (void)loadProductDataImage
{
    ...
    __weak ProductStaticCollectionViewCell *weakSelf = self;
...
{
    UIImageView *productImageView = [[UIImageView alloc] initWithFrame:self.bounds];
